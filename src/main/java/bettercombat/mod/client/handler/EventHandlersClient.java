...
public class EventHandlersClient
{
    ...
    public static void onMouseLeftClick(MouseEvent event) {
        ...
        RayTraceResult mov = getMouseOverExtended(4.0F);
...
//        }
    ...
    public static void onMouseRightClick()
    {
        ...
        {
//            RayTraceResult movs = getMouseOverExtended(ConfigurationHandler.longerAttack ? 5.0F : 4.0F);
//            if( movs != null && movs.entityHit != null )
//            {
//            net.minecraftforge.common.ForgeHooks.onPlayerAttackTarget(player, movs.entityHit);
//        	  System.out.println("+++");
//            }
...
//            player.setHeldItem(EnumHand.MAIN_HAND, mh);
            ...
            RayTraceResult mov = getMouseOverExtended(4.0F);
        	String s = stackOffHand.getItem().getRegistryName().toString();
        		 if ( s.contains("lance") ) 		{mov = getMouseOverExtended(6.2F);}
        	else if ( s.contains("pike") )  	 	{mov = getMouseOverExtended(6.2F);}
        	else if ( s.contains("glaive") ) 		{mov = getMouseOverExtended(4.8F);}
        	else if ( s.contains("halberd") ) 		{mov = getMouseOverExtended(4.8F);}
        	else if ( s.contains("greatsword") ) 	{mov = getMouseOverExtended(4.8F);}
        	else if ( s.contains("spear") ) 		{mov = getMouseOverExtended(4.8F);}
