...
public final class Helpers
{
    ...
    public static float getOffhandDamage(EntityPlayer player)
    {
        ...
        return (attack + 1.0F) * ConfigurationHandler.offHandEfficiency;
    }
...
//    @SubscribeEvent
//    public void attack(EntityInteract e)
//    {
//        e.getEntityPlayer().swingArm(EnumHand.OFF_HAND);
//    } 
    ...
    public static void attackTargetEntityItem(EntityPlayer player, Entity targetEntity, boolean offhand)
    {
    	...
    	if ( offhand )
    	{
    		player.setHeldItem(EnumHand.MAIN_HAND, new ItemStack(Items.WOODEN_SWORD, 1) );
    	}
        ...
        if ( offhand ) player.setHeldItem(EnumHand.MAIN_HAND, mh );
    }
